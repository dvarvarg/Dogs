...
width_label.pack(side='left',padx=(10,0)) #слева 10 пикселей, справа 0
...
# top_level_window.pack()

notebook=ttk.Notebook(top_level_window)
notebook.pack(expand=True, fill='both',padx=10,pady=10) # чтобы заполнить все пространство
